	...
	SubShader {
		...
		Pass {
			...
			Program "vp" {
				...
				SubProgram "gles hw_tier00 " {
					Keywords { "LKWD_LIGHTMAP_ON" "VERTEX_COLOUR" }
					"!!GLES
					#version 100
					...
					void main ()
					{
					  ...
					  lowp vec4 tmpvar_13;
					  tmpvar_13 = textureCube (_CubeMap, reflectVector_1);
					  baseColor_2.xyz = (baseColor_2.xyz * tmpvar_13.xyz);
					  baseColor_2.w = _ReflectionColor.w;
				...
				SubProgram "gles hw_tier00 " {
					Keywords { "FOG_LINEAR" "LKWD_LIGHTMAP_ON" "VERTEX_COLOUR" }
					"!!GLES
					#version 100
					...
					void main ()
					{
					  ...
					  baseColor_2.xyz = mix (unity_FogColor.xyz, baseColor_2.xyz, vec3(tmpvar_14));
					  gl_FragData[0] = baseColor_2;
					}
				...
				SubProgram "gles hw_tier00 " {
					Keywords { "FOG_EXP" "LKWD_LIGHTMAP_ON" "VERTEX_COLOUR" }
					"!!GLES
					#version 100
				...
				SubProgram "gles hw_tier00 " {
					Keywords { "FOG_EXP2" "LKWD_LIGHTMAP_ON" "VERTEX_COLOUR" }
					"!!GLES
					#version 100
